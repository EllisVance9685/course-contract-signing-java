...
> Design notes for **course-contract-signing-java** — a runnable java example that A Java service that prepares course contracts before learner deadlines and generates their PDF.
...
- **Feature code** — the actual task: course contract signing.
